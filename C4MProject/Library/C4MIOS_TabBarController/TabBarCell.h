...
@interface TabBarCell : C4MTabBarCell
{
...
@property(nonatomic, retain) IBOutlet UIView*     mBadgeView;
@property(nonatomic, retain) IBOutlet UILabel*    mBadgeValue;

- (void)updateWithBackgroundImage:(UIImage*)_image image:(UIImage*)_image highlightedImage:(UIImage*)_hlImage text:(NSString*)_text;
