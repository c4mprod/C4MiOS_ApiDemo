...
@interface CarouselViewController : UIViewController  <CurvedCarouselDataSource, CurvedCarouselDataSource>
{

    CurvedCarousel *mCurvedCarousel;
    NSArray* datas;
}

@property (nonatomic, retain) IBOutlet CurvedCarousel *mCurvedCarousel;
