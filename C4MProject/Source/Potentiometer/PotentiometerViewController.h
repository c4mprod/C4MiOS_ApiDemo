...
@interface PotentiometerViewController : UIViewController <C4MPotentiometerDelegate>
{
	IBOutlet C4MPotentiometer*		mStepByStepPotentiometer;
	IBOutlet C4MPotentiometer*		mFreePotentiometer;
}
