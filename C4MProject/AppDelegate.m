...
static NSString* const kAnalyticsAccountId = @"XXXXXXXX";
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
        ...
        [[BWHockeyManager sharedHockeyManager] setAppIdentifier:@"XXXXXXXX"];
        [[BWHockeyManager sharedHockeyManager] setDelegate:self];
        [[BWHockeyManager sharedHockeyManager] setAlwaysShowUpdateReminder:YES];
    #endif
    
    [[BWQuincyManager sharedQuincyManager] setAppIdentifier:@"XXXXXXXX"];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"C4MProject" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"C4MProject.sqlite"];
